...
const Header = () => {
  return <div className="header">FIRST REACT JS HEADER</div>;
};

const CreateArticle = () => {
  const img1 = newArticles[0].imgUrl;
  const price = newArticles[0].price;
  const title = newArticles[0].title;
  const location = newArticles[0].location;
